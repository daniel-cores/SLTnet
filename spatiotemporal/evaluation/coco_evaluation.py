...
def instances_to_coco_json(instances, img_id):
    ...
    if instances.has('attention_weights'):
        attention_weights = instances.attention_weights.tolist()
    else:
        attention_weights = [[] for _ in range(len(instances))]
    ...
    for k in range(num_instance):
        result = {
            ...
            "bbox": boxes[k],
            "score": scores[k],
            "attention_weights": attention_weights[k],
        }
        if has_mask:
